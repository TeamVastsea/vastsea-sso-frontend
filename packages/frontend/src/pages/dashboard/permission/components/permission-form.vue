...
<template>
  <div class="w-full">
    ...
    >
      <tiny-form-item
        v-if="!hiddenField.includes('name')"
        label="权限ID"
        prop="name"
      >
        <tiny-input
      ...
      <tiny-form-item
        v-if="!hiddenField.includes('desc')"
        label="权限简介"
        prop="desc"
      >
        <tiny-input
      ...
      <tiny-form-item
        v-if="!hiddenField.includes('clientId')"
        label="客户端"
        prop="clientId"
      >
        <client-select
          v-model="clients"
          placeholder="绑定的客户端"
          :disabled="readonlyField.includes('clientId')"
        />
      </tiny-form-item>
      <tiny-form-item
        v-if="!hiddenField.includes('active')"
        label="是否启用"
        prop="active"
      >
        <tiny-checkbox
          v-model="data.active"
          :disabled="readonlyField.includes('active')"
        >
